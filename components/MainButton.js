const MainButton = ({label, iconSrc, callback}) => {
  ...
  return (
    <button onClick={callback} class="w-80 relative inline-flex items-center justify-center shadow-lg shadow-gray-600 p-0.5 overflow-hidden rounded-lg group bg-gradient-to-br from-primary to-secondary">
