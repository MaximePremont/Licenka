...
const ApprovePage = () => {
  ...
  return (
    <div className="bg-background ">
      ...
      <section className="py-32 mx-32 flex justify-between">
      ...
      <section className="pb-32 flex justify-center space-x-16">
        <Image
          src="/computer.svg"
          width={475}
          height={483}
        ...
        <div className="mt-12 w-2/5 container">
          ...
          <p>
            Enable companies to deliver trusted licenses that are truly owned by
            their users.
          </p>
        </div>
      </section>
      <section className="pb-32 bg-background flex justify-center space-x-32">
        <div className="p-16 w-2/6 shadow-lg shadow-blue-500/50 space-y-4 rounded-xl bg-background">
          ...
          <p className="text-xl">
            No matter the size of your project, Licenka will allow you to manage
            your users and the sale of your licenses for only 3% of costs.
          </p>
        </div>
        <div className="p-16 w-2/6 shadow-lg shadow-blue-500/50 space-y-4 rounded-xl bg-background">
          <h1 className="text-5xl">As a User</h1>
          <p className="text-xl">
            Own your own license, and take advantage of the security offered by
            the blockchain.
          </p>
        </div>
      </section>
        ...
        <div className="mx-32 grid grid-cols-2 place-content-center gap-x-32 gap-y-16">
          <div className="flex justify-end">
            <div className="p-16 w-4/6 shadow-xl shadow-blue-500/50 space-y-4 rounded-xl bg-background">
              ...
              <p className="text-xl">
                Very easily create your own license on the blockchain with the
          ...
          <div className="flex justify-end">
            <div className="p-16 w-4/6 shadow-xl shadow-blue-500/50 space-y-4 rounded-xl bg-background">
              ...
              <p className="text-xl">
                ...
                advantage of everywhere, no matter if your platform is in Web2
                or Web3.
              </p>
            </div>
          </div>
